      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card className="p-6 space-y-4">
          ...
          <p className="text-slate-600">
            Drag and drop your invoice files or click to browse. Supports PDF, images, and multiple file formats.
          </p>
        </Card>
        ...
        <Card className="p-6 space-y-4">
          ...
          <p className="text-slate-600">
            Get extracted data instantly including invoice numbers, dates, amounts, and vendor information.
          </p>
        </Card>
      </div>
    </div>
