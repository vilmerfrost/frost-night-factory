 ...
 */
export async function selfDebugFile(
  filePath: string,
  projectRoot: string
 ...
 */
export async function selfDebugCriticalFiles(
  filePaths: string[],
  projectRoot: string
): Promise<SelfDebugResult[]> {
  const results: SelfDebugResult[] = [];
 ...
 */
export async function shouldRunSelfDebug(): Promise<boolean> {
  try {
