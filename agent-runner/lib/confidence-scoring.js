 ...
 */
export function calculateConfidence(code, testResults, semanticDistance, modelLogprobs = 0.8) {
    const factors = {
    ...
    // Weighted average
    const score = ((factors.syntaxValid ? 0.3 : 0) +
...
function validateSyntax(code) {
    try {
        ...
        const hasValidStructure = code.includes('function') ||
            code.includes('const') ||
