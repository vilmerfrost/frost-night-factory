...
export const logger = {
    ...
    step: (step, total, label) => {
        console.log(chalk.gray(`[${step}/${total}]`) + ' ' + chalk.white(label));
    },
    /**
    ...
    progress: (current, total, label) => {
        ...
        if (label) {
            console.log(`${chalk.cyan(label)} ${chalk.gray(`[${bar}]`)} ${chalk.white(`${percentage}%`)}`);
        }
        else {
            console.log(`${chalk.gray(`[${bar}]`)} ${chalk.white(`${percentage}%`)}`);
        }
    },
    /**
