...
/**
 * ✅ PHASE 4: Model Escalation System
 * Implements Lovable's tiered retry system + Perplexity's research
 * Escalates through model tiers based on error complexity
 */
 ...
 */
export function selectModelTier(errorType: string, attemptNumber: number): ModelTier | null {
 ...
 */
export async function escalatedFix(
  error: string,
  context: string,
  pipeline: any,
  prompt: string
