...
export async function generateAndTestContracts(workspacePath) {
...
async function parseEndpointsFromFastAPI(filePath) {
...
function inferResponseSchema(functionBody, functionName) {
...
async function testEndpointContract(provider, endpoint) {
...
async function verifyFrontendTypesMatchContracts(workspacePath, endpoints) {
