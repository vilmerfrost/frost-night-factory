...
const pipelineUpdateClients = new Map<string, Set<any>>()
 ...
 */
export function registerPipelineUpdateClient(client: any) {
 ...
 */
export function registerLogStreamClient(pipelineId: string, client: any) {
