...
export interface GoldenTask {
  ...
  expectedUXScore: number; // Minimum acceptable UX score
 ...
 */
async function saveRegressionResult(result: RegressionResult): Promise<void> {
  try {
 ...
 */
export async function getRegressionHistory(taskId: string, days: number = 30): Promise<RegressionResult[]> {
  try {
