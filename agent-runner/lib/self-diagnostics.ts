 ...
 */
export async function generateDiagnosticSummary(pipelineId: string): Promise<DiagnosticSummary | null> {
  try {
    // Get pipeline status
 ...
 */
export function getEditorPaths(pipelineId: string, projectRoot: string): {
  repoPath: string;
