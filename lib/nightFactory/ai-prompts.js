...
// =============================================================================
import { getTypeRegistryPrompt } from './type-registry';
/**
 * Build enhanced coder prompt with type registry
 */
export function buildCoderPrompt(fileToGenerate, context) {
 ...
 */
export function buildFixPrompt(errorMessage, targetFile, codeContext, fullFileContent) {
    const typeRegistry = getTypeRegistryPrompt();
    return `
 ...
 */
export function buildScaffoldPrompt(projectStructure, techStack) {
    const typeRegistry = getTypeRegistryPrompt();
    return `
