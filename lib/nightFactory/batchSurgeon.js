 ...
 */
export function parseErrors(errorLog) {
    const errors = [];
 ...
 */
export function groupErrorsIntoBatches(errors) {
 ...
 */
export function generateBatchFixPrompt(batch, projectPath, availableComponents = {}) {
 ...
 */
export async function fixErrorBatch(batch, projectPath, availableComponents = {}, parseAndWriteFiles) {
    ...
    try {
        ...
        console.error(`   ❌ Batch fix failed: ${e.message}`);
        return {
            batch,
            fixed: false,
            filesModified: [],
 ...
 */
export async function runBatchSurgeon(errorLog, projectPath, availableComponents, parseAndWriteFiles) {
 ...
 */
export function shouldUseBatchSurgeon(errorLog) {
    const errors = parseErrors(errorLog);
