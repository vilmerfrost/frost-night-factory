 ...
 */
export async function optimizeContextForCoder(researchData, plan) {
    const prompt = `
  ...
  `;
    try {
        ...
        const optimized = await generateContent(prompt, "You are a Technical Specification Writer. Be concise and precise.");
