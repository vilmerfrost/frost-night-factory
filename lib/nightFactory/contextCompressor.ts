 ...
 */
export async function compressContext(longText: string, type: 'code' | 'docs'): Promise<string> {
  if (!longText || longText.length < 500) return longText; // Don't compress small text
