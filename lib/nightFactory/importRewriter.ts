 ...
 */
export function extractImports(content: string): { importPath: string; line: number; fullMatch: string }[] {
  const imports: { importPath: string; line: number; fullMatch: string }[] = [];
 ...
 */
export function pathToAlias(absolutePath: string, projectRoot: string): string | null {
 ...
 */
export function runImportRewriter(projectPath: string): RewriteResult[] {
...
function scanDirectory(dir: string, projectRoot: string, results: RewriteResult[]): void {
 ...
 */
export function getBrokenImports(projectPath: string): { file: string; importPath: string; line: number }[] {
  const broken: { file: string; importPath: string; line: number }[] = [];
