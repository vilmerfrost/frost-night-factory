 ...
 */
function verifyProjectFiles(projectPath) {
    const criticalFiles = [
        'src/app/page.tsx',
        'app/page.tsx',
        'src/app/layout.tsx',
...
export async function runVisualAudit(projectPath) {
    ...
    try {
        ...
        const critique = await callAI("FRONTEND", DESIGN_DICTATOR_PROMPT, undefined, screenshot);
        console.log("---------------------------------------------------");
        ...
        return { success: true, score, screenshotBase64: screenshot };
    }
    catch (error) {
