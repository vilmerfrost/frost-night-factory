...
export async function runPromptArchitectPhase(
...
Return ONLY valid JSON with this structure:
{
  ...
  let output: PromptArchitectOutput;
  try {
    output = JSON.parse(jsonStr) as PromptArchitectOutput;
  } catch (e) {
...
async function writeCursorTaskFile(
  repoPath: string,
  project: string,
  output: PromptArchitectOutput
) {
