...
export class AdaptiveRecovery {
   ...
   */
  async recover(errorContext: ErrorContext): Promise<RecoveryResult> {
   ...
   */
  getAvailableStrategies(errorContext: ErrorContext): string[] {
 ...
 */
async function notifyHuman(error: ErrorContext): Promise<void> {
